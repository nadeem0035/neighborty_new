<?php 
/** Configuration file; f0ska xCRUD v.1.6.20; 06/2014 */
class Xcrud_config
{
    // default connection
//
    ...
    public static $dbpass = DBPASSWORD ; // // Your database password
    ...
    public static $sess_expire = 300; // Specifies the lifetime of the session, as well as the existence of a key safety (for example, the maximum edit-saving timeout).
    ...
    public static $limit = 30; // default limit of rows per page
    public static $limit_list = array('20', '50', '100','200', 'all'); // default limits list
    ...
    public static $enum_as_radio = true; // shows ENUM field as radiobox, dropdown by default
    public static $set_as_checkboxes = true; // shows SET field as checkboxes, multiselect by default
    public static $upload_folder_def = '../../images'; // Default uploads folder on your site, relative to xCRUD folder or absolute path required. Folder is must exist.
