...
(function($){
    ...
    $(".down").click(function() {
        $('html, body').animate({
            scrollTop: $(".mayraghar").offset().top
        }, 1500);
    });
   ...
   // var html_body = $("html, body");
    ...
    //var view_area = $('body').children('.property-listing');
    ...
    var advance_amenities = $('.advance-amenities');
    var field_expands = $('.field-expands');
    advance_amenities.on('click',function(){
        var advance_amenities_this = $(this);
        advance_amenities_this.toggleClass('active');
        if(advance_amenities_this.hasClass('active'))
        {
            advance_amenities_this.children('i').removeClass('fa-plus-square').addClass('fa-minus-square');
            field_expands.slideDown(function () {
                //alert('ok');
                $(".search-scroll-inners").animate({ scrollTop: $(document).height() });
            });
            //$(".search-scroll-inner").scrollTop($(".search-scroll-inner").scrollHeight());
        }else
        {
            advance_amenities_this.children('i').removeClass('fa-minus-square').addClass('fa-plus-square');
            field_expands.slideUp();
        }
    });
    ...
    var a_carousel_grid_1 = $(".agents-carousel-grid-1");
    if(a_carousel_grid_1.length > 0) {
        a_carousel_grid_1.owlCarousel({
            rtl: houzez_rtl,
            loop: false,
            dots: true,
            items:5,
        ...
        $('.btn-crl-pprt-1-prev').on('click',function() {
            a_carousel_grid_1.trigger('.owl.carousel',[1000])
        });
    ...
    var sale_slider = $(".sale-widget-slider");
    if(sale_slider.length > 0) {
    ...
    var wishlist_slider = $(".wishlist-widget-slider");
    if(wishlist_slider.length > 0) {
        wishlist_slider.owlCarousel({
            rtl: houzez_rtl,
            dots: false,
            items: 1,
            smartSpeed: 600,
    ...
    $('.misc_weight').on('click',function(){

        $('#next-section').html('Close')
        setInterval(function () {
            $('#next-section').attr("data-dismiss","modal");
        }, 1000);
    })

    $('.tabs_list').on('click',function(){

        $('#next-section').html('Next Session')
    })
