...
(function ($) {
    ...
    var initComponents = function() {
                ...
                fileReader.onload = function () {
                    ...
                    image.onload = function () {
                        ...
                        if (this.width > 600 || this.height >600) {
                            $(".bg-cropbox").hide();
                            $('.alert_msg').show();
                             setTimeout(function() {$(".btn-crop").hide()},100);
                        } else {
                             setTimeout(function() {$(".btn-crop").show()},100);
                            $(".bg-cropbox").show();
                        }
        ...
        initRatio = function() {
            var variant = getCurrentVariant();
            if( sourceImage.width >1000) return false;
...
$('#plugin').cropbox({
    selectors: {
        inputInfo: '.form-group input.data',
        inputFile: '.fileinput-button input[type="file"]',
        btnCrop: '.btn-crop',
        btnReset: '#plugin .btn-reset',
        resultContainer: '#image_preview .img-circle',
        messageBlock: '#message'
    },
    imageOptions: {
        class: 'img-circle',
        style: 'margin-right: 5px; margin-bottom: 5px;width:150px;height:150px;'
    },
    variants: [
        {
            width: 150,
...
/*$("#file").change(function(){
 setTimeout(function() {$(".btn-crop").show()},2000);
 });*/
$('.btn-crop').click(function(){
    $(".bg-cropbox").hide();
    $(".btn-crop").hide();
    $('#image_preview .outer_img').html('<img id="previewing" class="img-circle first_preview">');
})
