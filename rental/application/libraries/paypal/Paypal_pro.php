...
class PayPal_Pro {
    ...
    function __construct() {
        ...
        $DataArray['Sandbox'] = $this->_ci->config->item('Sandbox');
        $DataArray['APIVersion'] = $this->_ci->config->item('APIVersion');
        $DataArray['APIUsername'] = $this->_ci->config->item('APIUsername');
        $DataArray['APIPassword'] = $this->_ci->config->item('APIPassword');
        $DataArray['APISignature'] = $this->_ci->config->item('APISignature');
