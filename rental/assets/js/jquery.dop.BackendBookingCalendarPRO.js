...
(function ($) {
    $.fn.DOPBackendBookingCalendarPRO = function (options) {
        ...
        var Data = {'AddMonthViewText': 'Add month view',
            ...
            'ID': 0,
            'InfoLabel': 'Information (users will see this)',
...
// Calendar                
        methods_calendar = {
            ...
            display: function () {
                ...
                HTML.push('     <p class="alert alert-info">Choose Start date, End date, Price or Promo price and Click at "SAVE" button </p>');
        ...
        methods_form = {
            ...
            display: function (type) {
                ...
                if (type === 'days') {
                    ...
                    HTML.push('         <input type="text" name="DOPBCP-promo" id="DOPBCP-promo" value="" />');
                    HTML.push('     </div>');

                }
//                HTML.push('     <div class="dopbcp-input-wrapper">');
//                HTML.push('         <label class="dopbcp-for-textarea" for="DOPBCP-info">' + InfoLabel + '</label>');
//                HTML.push('         <textarea name="DOPBCP-info" id="DOPBCP-info" rows="2" cols=""></textarea>');
//                HTML.push('     </div>');
                ...
                HTML.push('   <input type="button" name="DOPBCP-submit" id="DOPBCP-submit" class="btn btn-default" title="Save" value="' + methods_form.text['submit'] + '" />');
                HTML.push('   <input type="button" name="DOPBCP-reset" id="DOPBCP-reset" class="btn btn-default" title="Reset" value="' + methods_form.text['reset'] + '" />');
                HTML.push('</div>');
                /*
                 * ***************************************************** End form buttons.
                 */
            ...
            events: function (startDate,
                ...
                $('#DOPBCP-submit').bind('click touchstart', function () {
                   // console.log($('#DOPBCP-status').val() + "==" + $('#DOPBCP-price').val() + "==" + $('#DOPBCP-promo').val());
                    if ($('#DOPBCP-status').val() == 'booked') {
                        methods_schedule.set(type);
                    } else if ($('#DOPBCP-status').val() == 'unavailable') {
                        methods_schedule.set(type);
                    } else if ($('#DOPBCP-status').val() == 'available' && $('#DOPBCP-price').val() > 0) {
                        methods_schedule.set(type);
                    } else {
