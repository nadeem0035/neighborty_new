var Inbox = function () {
    ...
    var loadInbox = function (el, name) {
        ...
        if (name == 'inbox') {
            ...
            var url = site_url + 'inbox/reservation/';
        } else if (name == 'archived') {
            var url = site_url + 'inbox/archived/';
        }
    ...
    var loadMessage = function (el, name, resetMenu) {
        ...
        if (name == 'inbox') {
            ...
            var url = site_url + 'inbox/reservation_view/';
        } else if (name == 'archived') {
            var url = site_url + 'inbox/archived_view/';
        }
        var title = $('.inbox-nav > li.' + name + ' a').attr('data-title');
    ...
    return {
        ...
        init: function () {
            ...
            $('.inbox-content').on('click', '.view-reservation', function () {
                loadMessage($(this), 'reservation');
            });

            $('.inbox-content').on('click', '.view-archived', function () {
                loadMessage($(this), 'archived');
            });
            ...
            $('.inbox-nav > li.reservation > a').click(function () {
                loadInbox($(this), 'reservation');
            });

            // handle trash listing
            $('.inbox-nav > li.archived > a').click(function () {
                loadInbox($(this), 'archived');
            });
