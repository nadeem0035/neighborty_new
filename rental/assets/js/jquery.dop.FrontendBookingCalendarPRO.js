        ...
        var Data = {"loadURL": "dopbcp/php-file/load.php",
                    ...
                    "search": {"data": {},
                               "text": {"checkIn": "Check in",
                                        ...
                                        "noServices": "There are no services available for the period you selected.Please check Availability calendar First!",
                                        "noServicesSplitGroup": "You cannot add divided groups to a reservation.",
                                        "title": "Search"}},
                    "sidebar": {"data": {"noItems": false,
...
// 10. Days
        ...
        methods_days = {
             ...
             */
                ...
                if (methods_search.days.validate(ciDay)
                    ...
                    $("#DOPBCPCalendar-info-message"+ID).removeAttr("style")
        ...
        methods_day = {
             ...
             */
                ...
                dayHTML.push('          <div class="dopbcp-co dopbcp-'+(methods_days.data['morningCheckOut'] ? methods_day.vars.previousStatus:status)+'"></div>');
                dayHTML.push('          <div class="dopbcp-ci dopbcp-'+status+'"></div>');
                dayHTML.push('          <div class="dopbcp-price pppp">'+contentLine1+'</div>');
                            ...
                            if (!$day.hasClass('dopbcp-mask')
                                 ...
                                 */
                                    ...
                                    $('#DOPBCPCalendar-check-in-view'+ID).val(methods_calendar.data['dateType'] === 1 ?
                                                                              methods_months.text['shortNames'][sMonth]+' '+sDay+', '+sYear:
                                                                              sDay+' '+methods_months.text['shortNames'][sMonth]+' '+sYear);
                                 ...
                                 */
                                    ...
                                    $('#DOPBCPCalendar-check-out-view'+ID).val(methods_calendar.data['dateType'] === 1 ?
                                                                               methods_months.text['shortNames'][eMonth]+' '+eDay+', '+eYear:
                                                                               eDay+' '+methods_months.text['shortNames'][eMonth]+' '+eYear);
                                    methods_search.days.initDatepicker('#DOPBCPCalendar-check-out-view'+ID,
                                                                       '#DOPBCPCalendar-check-out'+ID,
                                                                       minDateValue);
        ...
        methods_search = {
            ...
            days: {
                 ...
                 */
                     ...
                     * Check in.
                     */
                    HTML.push('         <div class="form-field field-input field-select col-md-4"><label class="home-labels tbc-barlabels">Check In</label>');
                    HTML.push('          <div class="checkin-tbc"><input type="text" name="DOPBCPCalendar-check-in-view'+ID+'" id="DOPBCPCalendar-check-in-view'+ID+'" class="field-input checkin-field-tbc" placeholder="check In" value="" required />');
                    HTML.push('          <input type="hidden" name="DOPBCPCalendar-check-in" id="DOPBCPCalendar-check-in'+ID+'" value="" />');
                    HTML.push('         </div></div>');
                     ...
                     */
                    if (methods_days.data['multipleSelect']){
                        HTML.push('     <div class="form-field field-input field-select col-md-4"><label class="home-labels tbc-barlabels">Check Out</label>');
                        HTML.push('     <div class="checkin-tbc"><input type="text" name="DOPBCPCalendar-check-out-view'+ID+'" id="DOPBCPCalendar-check-out-view'+ID+'" class="field-input checkin-field-tbc" placeholder="check Out" value="" required />');
                        HTML.push('         <input type="hidden" name="DOPBCPCalendar-check-out" id="DOPBCPCalendar-check-out'+ID+'" value="" />');
                        HTML.push('     </div> </div>');
                    }
                    HTML.push('');
                 ...
                 */
                    ...
                    $(id).datepicker({altField: altId,
                                      ...
                                      dateFormat: methods_calendar.data['dateType'] === 1 ? 'M dd, yy':'dd MM yy',
        ...
        methods_reservation = {
             ...
             */
                ...
                if (methods_reservation.reservation['price'] !== 0){
                    ...
                    HTML.push(' <tr>');
                    HTML.push('     <td class="dopbcp-label jj">'+methods_reservation.text['price']+'</td>');
                    HTML.push('     <td class="dopbcp-value tt dopbcp-price">');
        ...
        methods_order = {
             ...
             */
                ...
                $.post(ajaxSendURL, {dopbcp_calendar_id: ID,
                    ...
                    methods_info.toggleMessages((methods_order.text['success']),
                                                'dopbcp-success');
                    methods_reservation.clear();
