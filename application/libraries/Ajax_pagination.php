...
class Ajax_pagination{
    ...
    var $uri_segment		= 3;
    var $full_tag_open		= '<ul class="pagination meo">';
    var $full_tag_close		= '</ul>';
    var $first_tag_open		= '<li>';
    var $first_tag_close	= '</li>';
    var $last_tag_open		= '<li>';
    var $last_tag_close		= '</li>';
    var $cur_tag_open		= '<li class="active"><a href="javascript:void()">';
    ...
    function getAJAXlink($count, $text) {
        ...
        //return '<a href="javascript:void(0);"' . $this->anchor_class . '  data-href="'. $this->base_url . $count .'" onclick="'.$this->link_func.'('.$pageCount.')">'. $text .'</a>';
        return "<a data-href=". $this->base_url . $count ."  pagination-page=".($pageCount)." ajax-page=1 >". $text .'</a>';
    }
}
