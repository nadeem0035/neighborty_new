                ...
                <div class="profile-area-content">
                    <div class="profile-top">
                        <div class="profile-top-left">
                            <h2 class="title">Mes Rendezvous</h2>
                        </div>
                        <?php if($_SESSION['logged_in']['user_type'] == 'Agent' || $_SESSION['logged_in']['user_type'] == 'Both'){?>

                        <div class="profile-top-right">
                            <div class="my-property-search text-right">
                                <a href="#" id="add-availab-form" class="btn btn-secondary">Ajouté disponibilité</a>

                                <!--<a href="#" data-toggle="modal" data-target="#add_availability" class="btn btn-secondary">Add Availability</a>-->
                            </div>
                        </div>
                    ...
                    <div class="detail-bar">
                        <div class="detail-content-tabber">
                            <ul class="detail-tabs">
                                ...
                                <li class="<?=($_SESSION['logged_in']['user_type'] == 'Renter' ? 'active' :'');?>">Mes Rendezvous</li>
