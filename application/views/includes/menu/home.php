<header class="header_section_4 header-main splash-header hidden-sm hidden-xs" data-sticky="1">
            ...
            <nav class="navi main-nav">
                <ul>
                  ...
                  <!--  <li><a href="<?/*= site_url('about') */?>"><?/*=$this->lang->line('about');*/?></a></li>-->
                    <li><a href="<?= site_url('/login') ?>"><?=$this->lang->line('invest');?></a></li>
                    <li><a href="<?= site_url('/blog') ?>"><?=$this->lang->line('neig_secure');?></a></li>
                    <li><a href="<?= site_url('/login') ?>"><?=$this->lang->line('rend_by_neigh');?></a></li>
                   <!-- <li><a href="<?/*=site_url('/blog');*/?>">Blog</a></li>-->
                </ul>
            </nav>
        </div>
        <div class="header-logo">
            <a href="<?=site_url('/');?>"><img src="<?=base_url()?>assets/img/white_logo1.png" alt="logo" width="180px" height="70px"></a>
        </div>
