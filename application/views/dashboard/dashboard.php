            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-left">
                        <h1 class="title-head">Welcome, <?php $session_data = $this->session->userdata('logged_in'); $uid = $session_data['id'];
                            echo ucwords($session_data['full_name']);
                            ?> </h1>
                    </div>
                    <div class="page-title-right">
                        <ol class="breadcrumb"><li><a href=""><i class="fa fa-home"></i></a></li><li class="active">Dashboard</li></ol>
                    </div>
            ...
            <div class="profile-area-content">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="module-title-nav clearfix">
                                    <div>
                                        <h2 class="title">Sauvegardé récemment</h2>
                                    </div>
                                    ...
                                    <?php foreach($latest_home as $list) :?>
                                        <div class="item">
                                            <div class="figure-block">
                                                <figure class="item-thumb 1">
                                                    <div class="label-wrap label-left">
                                                        <!--<span class="label label-success">Featured</span>-->
                                                        <span class="label-status label label-default"><?=($list->property_type == 'rent' ? 'A Louer' :$list->property_type);?></span>
                                                    </div>
                                                    <?php
                                                    ...
                                                    <ul class="actions">
                                                        ...
                                                        <li class="share-btn">
                                                            <?php
                                                            $data= array('list_img'=>base_url() . "assets/media/properties/small/".$list->preview_image_url,'slug'=>$list->slug.'-'.$list->listid,'description'=>$list->summary);
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <div class="white-block">
                            <div class="portlet-title">
                                Messages récents <span class="caption-helper">(<?= $messages_count; ?> pending)</span>
                                <a href="<?= site_url("inbox") ?>" class="caption-sm">View All</a>
                            </div>
                            <div class="portlet-body">
                                    ...
                                    <div class="general-item-list">
                                        ...
                                        if ($recent_chats) {
                                            ...
                                            foreach ($recent_chats as $message) {
                                                ?>
                                                <div class="item">
                                                    <img class="img-circle" src='<?= base_url() . $users_avatar . "small/" . $message->picture; ?>' height="35px" width="35px"/>
                                            ...
                                            echo '<p class="text-center" style="font-size:14px;">
                                                    <br/><br/>Vous n’avez pas envoyés de nouveaux messages.
                                                    <br/>Commencez aujourd’hui en contactant un agent 
                                                    <br/><br/>
                                                    <a class="btn btn-primary btn-md" href="'.site_url("agents").'">Find Agents</a>
                                                    </p>';
                                        }
                                        ?>
                                    </div>
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="white-block">
                            <div class="portlet-title">
                                Récent Rendezvous </span>
                                <a href="<?= site_url("appointments") ?>" class="caption-sm">View All</a>
                            </div>
                            <div class="portlet-body">
                                <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 305px;">
                                    <div class="general-item-list">
                                        ...
                                        <?php } else{ ?>
                                            ...
                                            <p class="text-center" style="font-size:14px;"><br/><br/>
                                                Vous n’avez pas encore planifié de rendez-vous.
                                                <br/>
                                                Commencez aujourd’huien prenant rendez-vous avec un agent
                                                <br/><br/>
                                                <a class="btn btn-primary btn-md" href="<?=site_url('agents');?>">Réservez un RDV</a>
                                            </p>
                                    ...
                                    <div class="general-item-list">
                                        ...
                                        if (isset($reviews_to) && $reviews_to != NULL) {
                                            foreach (array_slice($reviews_to, 0,3) as $review_to) {
                                                ...
                                                ?>
                                                <div class="item">
                                                    <img class="img-circle" src="<?= base_url() . $users_avatar . 'small/' . $review_to->picture; ?>" alt="" width="35px" height="35px" />
                                                    <div class="item-details">
                                            ...
                                            echo '<p class="text-center" style="font-size:14px;"><br/><br/>Pas de commentaires trouver</p>';
                                        }
                                        ?>
                                    </div>
                                </div>
