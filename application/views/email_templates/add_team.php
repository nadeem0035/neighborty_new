            ...
            <table class="table-inner" width="600" align="center" border="0" cellspacing="0" cellpadding="0" style="padding:10px;">
                <tr>
                    ...
                    <td align="right" valign="middle" class="block">
                        <a style="border:#fff solid 1px; background-color:#004274; border-radius:4px; width:25px; height:25px; text-align:center; display:inline-block; margin:6px 5px 0px 0px;" href="https://www.facebook.com/neighborty/" target="_blank">
                            <img src="<?=base_url();?>assets/media/newsletter/fb.png"  width="100%" />
                        </a>
                        <a style="border:#fff solid 1px; background-color:#004274; border-radius:4px; width:25px; height:25px; text-align:center; display:inline-block; margin:6px 5px 0px 0px;" href="#" target="_blank">
                            <img src="<?=base_url();?>assets/media/newsletter/tw.png" width="100%" />
                        </a>
                        <a style="border:#fff solid 1px; background-color:#004274; border-radius:4px; width:25px; height:25px; text-align:center; display:inline-block; margin:6px 5px 0px 0px;" href="#" target="_blank">
                            <img src="<?=base_url();?>assets/media/newsletter/pint.png"  width="100%" />
                        </a>
                        <a style="border:#fff solid 1px; background-color:#004274; border-radius:4px; width:25px; height:25px; text-align:center; display:inline-block; margin:6px 5px 0px 0px;" href="https://www.instagram.com/neighborty_inc/" target="_blank">
        ...
        <td align="center" width="100%">
            <table class="table-inner" width="600" align="center" border="0" cellspacing="0" cellpadding="0">
                <tr style="background-color:#00aeef;">
                    <td valign="middle" align="center" colspan="2" style="padding:10px; color:#FFF">
                        <strong style="font-family:Open sans,Arial,Sans-serif; font-size:18px; text-transform:uppercase;">Congratulation!</strong>
                    </td>
                </tr>
                <tr>
                    <td valign="top" colspan="2" style="padding:30px 10px 10px; background-color:#f6f6f6;">
                        <strong style="font-family:Open sans,Arial,Sans-serif; font-size:16px; color:#434343; width:100%; float:left; padding-bottom:8px; font-weight:700; border-bottom:2px solid #616161">Hello <?=($receiver_name);?>,</strong>
                    </td>
                </tr>

                <tr style="font-family:Open sans,Arial,Sans-serif;">
                    <td valign="top" align="left" colspan="2" style="padding:10px 10px;">
                        <br />
                        <p style="width:100%; margin:0px; font-size:15px;line-height:24px;">
                            You have been added as team member on neighborty.com, <a style="color:#00aeef" target="_blank" href="<?=base_url();?>login">Login Now</a> to get started
                            <br /><br />
                            Below are your credientials
                        </p>
                        <br />
                    </td>
                </tr>
                ...
                <tr style="font-family:Open sans,Arial,Sans-serif; font-size:14px;">
                    <td valign="top" style="padding:10px 20px; font-weight:600;">Username:</td>
                    <td valign="top" style="padding:10px 5px;"><?=$email;?></td>
                </tr>
                <tr style="font-family:Open sans,Arial,Sans-serif; font-size:14px;">
                    <td valign="top" style="padding:10px 20px; font-weight:600;">Password:</td>
                    <td valign="top" style="padding:10px 5px;"><?=$password;?></td>
                </tr>
                ...
                <tr>
                    <td valign="top" colspan="2" style="padding:25px 10px; background-color:#f6f6f6;">
                        <div style="color:#434343; font-family:Open sans,Arial,Sans-serif; font-size:14px; line-height: 150%; text-align: left; border-top:1px solid #C5C5C5">
                            <p style="color:#464646; font-size:13px;">Sincerely,<br />Team Neighborty</p>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td align="center">
                        <p style="font-family:Open sans,Arial,Sans-serif; font-size:13px; color:#FFF; font-weight:500">
                            © <a href="http://beta.neighborty.com" target="_blank" style="color:#FFF">Neighborty</a> <?=date('Y');?> - All Rights Reserved.
                        </p>
                    </td>
                </tr>
            </table>
