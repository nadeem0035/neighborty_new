                    ...
                    <tr>
                        <td align="center" valign="top">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF;border:1px solid #EEEEEE;" width="100%" class="oneColumn">
                                ...
                                <tr>
                                    <td align="center" valign="top" style="padding-top:25px;padding-bottom:10px;padding-left:20px;padding-right:20px;" class="title">
                                        <!-- Main Title Text // -->
                                ...
                                <tr>
                                    <td align="center" valign="top" style="padding-bottom:20px;padding-left:20px;padding-right:20px;" class="subTitle">
                                        <!-- Sub Title Text // -->
                                        <h4 class="midTitle" style="color:#919191; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:17px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:26px; text-align:center; padding:0; margin:0;">
                                            Contact Messages
                                        </h4>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td align="center" valign="top" style="padding-bottom:40px;padding-left:20px;padding-right:20px;" class="description">
                                        <p class="midText" style="color:#313131; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:16px; font-weight:400; line-height:22px; text-align:center; padding:0; margin:0;">
                                            Your message is sent to the team<strong> Zoney!</strong>a member will contact you as soon as possible.
                                        </p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td align="left" valign="top" style="padding-bottom:40px;padding-left:20px;padding-right:20px;" class="description">
                                        ...
                                        <p class="midText" style="color:#919191; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; line-height:22px; text-align:left; padding:0; margin:0;">
                                            <span style="font-weight:600;display:inline-block; width:90px;">Name:</span><?=($poster_name);?><br/>
                                            <span style="font-weight:600;display:inline-block; width:90px;">Email:</span><?=($poster_email);?><br/>
                                            <span style="font-weight:600;display:inline-block; width:90px;">Phone:</span><?=($poster_phone);?><br/>
                                            <span style="font-weight:600;display:inline-block; width:90px;">Country:</span><?=($poster_country);?><br/>
                                            <span style="font-weight:600;display:inline-block; width:90px;">Object:</span><?=($poster_reason_of_inq);?>
                                            <br/>
                                            <strong>Message:</strong> <?=($poster_message);?>
                                        </p>
                                    </td>
                                </tr>
