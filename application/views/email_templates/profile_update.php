                        ...
                        <td align="center" valign="top">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF;border:1px solid #EEEEEE;" width="100%" class="oneColumn">
                                ...
                                <!--<tr>
                                    <td align="center" valign="top" style="padding-bottom:40px;padding-left:20px;padding-right:20px;" class="description">
                                        <p class="midText" style="color:#919191; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; line-height:22px; text-align:left; padding:0; margin:0;">
                                            <?php /*if($flag =='avatar'){ */?>
                                                <multiline label="content">The Avatar associated with your Neighborty account was updated on <strong><a style="color:#0287d0" href="#"><?/*=$update_date;*/?> at <?/*=$update_time;*/?></a></strong>.</multiline>
                                            <?php /*} else{ */?>
                                                <multiline label="content">The profile associated with your Neighborty account was updated on <strong><a style="color:#0287d0" href="#"><?/*=$update_date;*/?> at <?/*=$update_time;*/?></a></strong>.</multiline>
                                            <?php /*}*/?>
                                        </p>
                                    </td>
                                </tr>-->
                                ...
                                <tr>
                                    <td align="center" valign="top" style="padding-bottom:40px;padding-left:20px;padding-right:20px;" class="description">
                                        <p class="midText" style="color:#919191; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; line-height:22px; text-align:left; padding:0; margin:0;">
                                            Your profile information has been updated. If you haven’t done this, please
                                            <a style="color:#0287d0;text-decoration:none;" target="_blank" href="<?=base_url();?>contact">Contact Team Neighborty</a> right away.
                                        </p>
                                    </td>
                                </tr>
