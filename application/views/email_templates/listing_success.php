            ...
            <table class="table-inner" width="600" align="center" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td valign="middle" align="center" colspan="2" style="padding:; background-color:#00aeef; padding:10px; color:#FFF">
                        <strong style="font-family:Open sans,Arial,Sans-serif; font-size:18px; text-transform:uppercase;">Congratulations !!</strong>
                    </td>
                </tr>
                ...
                <tr style="font-family:Open sans,Arial,Sans-serif;">
                    <td valign="top" align="left" colspan="2" style="padding:25px 10px;">
                        <br />
                        <p style="width:100%;margin:0px; font-size:14px;">Thank you for submitting a new listing. We are currently reviewing your listing application.<br />
                            <br />
                            You should hear from us in the next 48 hours. If you have any questions about the process or its status, feel free to

                            <a style="color:#00aeef" target="_blank" href="<?=base_url();?>contact">Contact Us</a>
                        </p>
                ...
                <tr>
                    <td align="center">
                        <p style="font-family:Open sans,Arial,Sans-serif; font-size:13px; color:#FFF; font-weight:500">
                            © <a href="<?=site_url('/');?>" target="_blank" style="color:#FFF">Zoney</a> 2015 - 2017 - All Rights Reserved.
                        </p>
                    </td>
                </tr>
            </table>
