                                ...
                                <tr>
                                    <td align="center" valign="top" style="padding-bottom:20px;padding-left:20px;padding-right:20px;" class="subTitle">
                                        ...
                                        <h4 class="midTitle" style="color:#919191; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:16px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:26px; text-align:center; padding:0; margin:0;">
                                            <strong>Congratulations !</strong><br/>Your rental file has been sent to :
                                            <a href="<?=base_url();?>property/<?=$slug .'-'.$list_id ?>" style="color:#0287d0;text-decoration:none;"><?= ($listing_name); ?></a>
                                        </h4>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td align="center" valign="top" style="padding-bottom:40px;padding-left:20px;padding-right:20px;" class="description">
                                        ...
                                        <p class="midText" style="color:#919191; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; line-height:22px; text-align:center; padding:0; margin:0;">
                                            The officer in charge of your file should answer you as soon as possible to discuss with you the details of your application. If you have not received a response, please contact the agency in charge of your file directly.
                                        </p>
                                    </td>
                                </tr>
                                        ...
                                        <table align="center" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td align="center" class="postButton" style="background-color:#00aeef;padding-top:10px;padding-bottom:10px;padding-left:25px;padding-right:25px;border-radius:2px">
                                                    <!-- Button Link // -->
                                                    <a href="<?=base_url();?>applications" target="_blank" style="color:#FFFFFF; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:12px; font-weight:600; letter-spacing:1px; line-height:20px; text-transform:uppercase; text-decoration:none; display:block;" >
                                                        See your rental record
                                                    </a>
                                                </td>
                                            </tr>
                                        </table>
