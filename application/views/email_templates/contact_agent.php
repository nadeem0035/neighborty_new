                                ...
                                <tr>
                                    <td align="center" valign="top" style="padding-bottom:20px;padding-left:20px;padding-right:20px;" class="subTitle">
                                        ...
                                        <h4 class="midTitle" style="color:#919191; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:18px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:26px; text-align:center; padding:0; margin:0;">
                                            You have received a new contact message from <?=$poster_name;?>
                                        </h4>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td align="left" valign="top" style="padding-bottom:40px;padding-left:20px;padding-right:20px;" class="description">
                                        <table>
                                            <tbody>
                                                <tr>
                                                    <td align="left" valign="top" style="padding-bottom:10px;padding-left:5px;padding-right:5px;" class="subTitle">Name:</td>
                                                    <td align="left" valign="top" style="padding-bottom:10px;padding-left:5px;padding-right:5px;"><?=$poster_name;?></td>
                                                </tr>
                                                <tr>
                                                    <td align="left" valign="top" style="padding-bottom:10px;padding-left:5px;padding-right:5px;" class="subTitle">Email:</td>
                                                    <td align="left" valign="top" style="padding-bottom:10px;padding-left:5px;padding-right:5px;"><?=$poster_email;?></td>
                                                </tr>
                                                <tr>
                                                    <td align="left" valign="top" style="padding-bottom:10px;padding-left:5px;padding-right:5px;" class="subTitle">Phone:</td>
                                                    <td align="left" valign="top" style="padding-bottom:10px;padding-left:5px;padding-right:5px;"><?=$poster_phone;?></td>
                                                </tr>
                                                <tr>
                                                    <td align="left" valign="top" style="padding-bottom:10px;padding-left:5px;padding-right:5px;" class="subTitle">Message:</td>
                                                    <td align="left" valign="top" style="padding-bottom:10px;padding-left:5px;padding-right:5px;"><?=$message;?></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        <!-- Description  Text// -->
