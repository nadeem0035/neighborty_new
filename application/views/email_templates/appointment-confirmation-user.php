                    ...
                    <tr>
                        <td align="center" valign="top">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF;border:1px solid #EEEEEE;" width="100%" class="oneColumn">
                                ...
                                <tr>
                                    <td align="center" valign="top" style="padding-bottom:40px;padding-left:20px;padding-right:20px;" class="description">
                                        <p class="midText" style="color:#919191; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; line-height:22px; text-align:center; padding:0; margin:0;">
                                            This e-mail is to confirm that your appointment has been confirmed.
                                        </p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td align="left" valign="top" style="padding-bottom:5px;padding-left:20px;padding-right:20px;" class="infoTitle">
                                        <p class="midTitle" style="color:#313131; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:16px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:24px; text-align:center; padding:0; margin:0;">
                                            Appointment Details :
                                        </p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td align="left" valign="top" style="padding-bottom:40px;padding-left:20px;padding-right:20px;" class="address">
                                        ...
                                        <p class="midText" style="color:#919191; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; line-height:20px; text-align:center; padding:0; margin:0;">
                                            Seller Name: <a href="<?=$agent_url;?>" style="color:#0287d0;text-decoration:none;"><?=$agent_name;?></a>
                                            <br/>
                                            <span style="font-weight:500;">Date / Time:</span> <?=$appointment_time;?>
                                            <br/>
                                            <span style="font-weight:500;">Property Name:</span> <a href="<?=$listing_url;?>" style="color:#0287d0;text-decoration:none;"><?=$listing_name;?></a>
                                            <br/>
                                            <span style="font-weight:500;">Property Address:</span> <?=$listing_address;?>
                                            <br/>
                                            <span style="font-weight:500;">Phone Number:</span> <?=$agent_phone?>
                                            <br/>
                                            <span style="font-weight:500;">Email:</span> <?=$agent_email?>
                                        </p>
                                    </td>
                                </tr>
                                        ...
                                        <table align="center" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td align="center" class="postButton" style="background-color:#0287d0;padding-top:10px;padding-bottom:10px;padding-left:25px;padding-right:25px;border-radius:2px">
                                                    <a href="<?=$msg_url;?>" target="_blank" style="color:#FFFFFF; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:12px; font-weight:600; letter-spacing:1px; line-height:20px; text-transform:uppercase; text-decoration:none; display:block;" >
                                                        Contact Seller
                                                    </a>
                                                </td>
                                            </tr>
                                ...
                                <!--<tr>
                                    <td align="center" valign="top" style="padding-bottom:20px;padding-left:20px;padding-right:20px;" class="subTitle">
                                        <h4 class="midTitle" style="color:#919191; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:16px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:26px; text-align:center; padding:0; margin:0;">
                                            This email confirms your appointment for: <?/*=$listing_name;*/?>:
                                        </h4>
                                    </td>
                                </tr>-->

                                <!--<tr>
                                    <td align="center" valign="top" style="padding-bottom:15px;padding-left:20px;padding-right:20px;">
                                        <table align="center" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td valign="top" align="left">
                                                    <a href="<?/*=$listing_url;*/?>"><img src="<?/*=$listing_pictue;*/?>" alt="" width="180"/></a>
                                                </td>
                                                <td>
                                                    <p class="midText" style="color:#313131; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:14px; font-weight:400;line-height:28px; text-align:left; padding:0 0 0 15px; margin:0;">
                                                        <a href="<?/*=$listing_url;*/?>" style="font-size:16px;font-weight:600;color:#313131;text-decoration:none;"><?/*=$listing_name;*/?></a>
                                                        <br/>
                                                        <span style="line-height:22px;"><?/*=$listing_address;*/?></span>
                                                        <br/>
                                ...
                                <!--<tr>
                                    <td align="center" valign="top" style="padding-bottom:20px;padding-left:20px;padding-right:20px;" class="description">
                                        <a href="<?/*=$agent_url;*/?>" target="_blank" style="display: inline-block;">
                                            <img mc:edit="cardID" src="<?/*=$agent_picture;*/?>" alt="" width="70" border="0" style="height:auto;display:block;border-radius:50%;">
                                        </a>
                                        <p class="midText" style="color:#919191; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; line-height:22px; text-align:center; padding:10px 0 0; margin:0;">
                                            <a href="<?/*=$agent_url;*/?>" style="color:#00aeef;font-size:17px;padding:5px 0px;text-decoration:none;font-weight:600"><?/*=$agent_name;*/?></a>
                                            <br/>
                                            <strong>Phone:</strong><?/*=$agent_phone*/?>,
                                            <strong>Email:</strong> <a href="#" style="color:#0287d0;text-decoration:none;"><?/*=$agent_email*/?></a>
                                        </p>
                                    </td>
                                </tr>-->

                                <!--<tr>
                                    <td align="center" valign="top" style="padding-bottom:15px;padding-left:20px;padding-right:20px;" class="btnCard">
                                        <table align="center" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td align="center" class="postButton" style="background-color:#0287d0;padding-top:10px;padding-bottom:10px;padding-left:25px;padding-right:25px;border-radius:2px">
                                                    <a href="<?/*=$app_url;*/?>" target="_blank" style="color:#FFFFFF; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:12px; font-weight:600; letter-spacing:1px; line-height:20px; text-transform:uppercase; text-decoration:none; display:block;" >
                                                        See the Appointment
                                                    </a>
                                                </td>
                                                <td align="center" class="postButton" style="padding-top:10px;padding-bottom:10px;padding-left:5px;padding-right:5px;"></td>
                                                <td align="center" class="postButton" style="background-color:#0287d0;padding-top:10px;padding-bottom:10px;padding-left:25px;padding-right:25px;border-radius:2px">
                                                    <a href="<?/*=$msg_url;*/?>" target="_blank" style="color:#FFFFFF; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:12px; font-weight:600; letter-spacing:1px; line-height:20px; text-transform:uppercase; text-decoration:none; display:block;" >
