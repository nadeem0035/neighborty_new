                ...
                <div class="col-sm-12 col-xs-12">
                    <div class="header-detail table-list">
                        <div class="header-left">
                            ...
                            <h1>
                                <?= ucwords($listing->listing_name) ?>
                                <span class="label-wrap hidden-sm hidden-xs">
                                        <span class="label label-primary">For Sale</span>
                                        <span class="label label-danger">Sold</span>
                                    </span>
                            </h1>
                            <address class="property-address"><?php echo $listing->address_line_1.' '.$listing->address_line_2.', '.$listing->city_town.', '.$listing->state_province.' '.$listing->zip_postal_code?></address>
                        </div>
                        <div class="header-right">
                            ...
                            <span class="item-price"><?php echo "$".$listing->price?></span>
                                ...
                                <div id="gallery" class="tab-pane fade in active">
                                    ...
                                    <div class="slideshow">
                                        <div class="slideshow-main">
                                            <div class="slide">
                                                <div>
                                                    <img src="<?= base_url() ?>assets/media/listings/01_810x430.jpg" width="810" height="430" alt="Slide show">
                                                </div>
                                                <div>
                                                    <img src="<?= base_url() ?>assets/media/listings/02_810x430.jpg" width="810" height="430" alt="Slide show">
                                                </div>
                                                <div>
                                                    <img src="<?= base_url() ?>assets/media/listings/03_810x430.jpg" width="810" height="430" alt="Slide show">
                                                </div>
                                                <div>
                                                    <img src="<?= base_url() ?>assets/media/listings/04_810x430.jpg" width="810" height="430" alt="Slide show">
                                                </div>
                                                <div>
                                                    <img src="<?= base_url() ?>assets/media/listings/05_810x430.jpg" width="810" height="430" alt="Slide show">
                                                </div>
                                                <div>
                                                    <img src="<?= base_url() ?>assets/media/listings/06_810x430.jpg" width="810" height="430" alt="Slide show">
                                                </div>
                                                <div>
                                                    <img src="<?= base_url() ?>assets/media/listings/07_810x430.jpg" width="810" height="430" alt="Slide show">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="slideshow-nav-main">
                                            <div class="slideshow-nav">
                                                <div>
                                                    <img src="<?= base_url() ?>assets/media/listings/01.jpg" width="100" height="70" alt="Slide show thumb">
                                                </div>
                                                <div>
                                                    <img src="<?= base_url() ?>assets/media/listings/02.jpg" width="100" height="70" alt="Slide show thumb">
                                                </div>
                                                <div>
                                                    <img src="<?= base_url() ?>assets/media/listings/03.jpg" width="100" height="70" alt="Slide show thumb">
                                                </div>
                                                <div>
                                                    <img src="<?= base_url() ?>assets/media/listings/04.jpg" width="100" height="70" alt="Slide show thumb">
                                                </div>
                                                <div>
                                                    <img src="<?= base_url() ?>assets/media/listings/05.jpg" width="100" height="70" alt="Slide show thumb">
                                                </div>
                                                <div>
                                                    <img src="<?= base_url() ?>assets/media/listings/06.jpg" width="100" height="70" alt="Slide show thumb">
                                                </div>
                                                <div>
                                                    <img src="<?= base_url() ?>assets/media/listings/07.jpg" width="100" height="70" alt="Slide show thumb">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade">
                                        <div class="detail-address detail-block">
                                            ...
                                            <ul class="list-three-col">
                                                <li><strong>Address:</strong> <?php echo $listing->address_line_1.' '.$listing->address_line_2 ?></li>
                                                <li><strong>City:</strong> <?php echo $listing->city_town ?></li>
                                                <li><strong>State/Country:</strong> <?php echo  $listing->state_province ?></li>
                                                <li><strong>Zip:</strong> <?php echo  $listing->zip_postal_code?></li>
                                                <li><strong>Country:</strong> <?php echo $listing->country ?></li>
                                                <li><strong>Neighbourhood:</strong> <?php echo $listing->typed_address ?></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade">
                                            ...
                                            <?php if (isset($amenities)) { ?>
                                                <ul class="list-three-col list-features">
                                                    ...
                                                    foreach ($amenities as $aminity) {
                                                        ?>
                                                        <li><a href="#"><i class="fa fa-check"></i><?= $aminity->name ?></a></li>
                                    ...
                                    <div class="tab-pane fade">
                                        <div class="detail-list detail-block">
                                            ...
                                            <div class="alert alert-info">
                                                <ul class="list-three-col">
                                                    <li><strong>Property ID:</strong> <?= $listing->id ?></li>
                                        ...
                                        <div class="property-plans detail-block">
                                            ...
                                            <div class="accord-block">
                                                ...
                                                <div class="accord-content" style="display: block">
                                                    <img src="<?= base_url() ?>assets/img/floor-image.png" alt="img" width="400" height="436">
                                                </div>
                                                <div class="accord-tab">
                                                    <h3>Floor Plan B</h3>
                                                    <ul>
                            ...
                            <div class="prev-box pull-left">
                                <div class="media">
                                    <div class="media-left">
                                        <a href="#">
                                            <img src="<?= base_url() ?>assets/media/listings/02_100x75.jpg" class="media-object" alt="image" width="100" height="75">
                                        </a>
                                    </div>
                            ...
                            <div class="next-box pull-right">
                                <div class="media">
                                    ...
                                    <div class="media-right">
                                        <a href="#">
                                            <img src="<?= base_url() ?>assets/media/listings/03_100x75.jpg" class="media-object" alt="image" width="100" height="75">
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="widget widget-calculate">
                            <div class="widget-body">
                                <div class="media agent-media">
                                    <div class="media-left">
                                        <a href="#">
                                            <img src="<?= base_url() ?>assets/media/listings//03_100x100.jpg" class="media-object" alt="image" width="100" height="100">
                                        </a>
                                    </div>
                            ...
                            <div class="widget-body">
                                    ...
                                    <div class="media-left">
                                        <figure class="item-thumb">
                                            <a class="hover-effect" href="#">
                                                <img src="<?= base_url() ?>assets/media/listings/01_100x75.jpg" width="100" height="75" alt="thumb">
                                            </a>
                                        </figure>
                                    </div>
                                    <div class="media-body">
                                ...
                                <div class="media">
                                    <div class="media-left">
                                        <figure class="item-thumb">
                                            <a class="hover-effect" href="#">
                                                <img src="<?= base_url() ?>assets/media/listings/02_100x75.jpg" width="100" height="75" alt="thumb">
                                            </a>
                                        </figure>
                                    </div>
                                    <div class="media-body">
                                ...
                                <div class="media">
                                    <div class="media-left">
                                        <figure class="item-thumb">
                                            <a class="hover-effect" href="#">
                                                <img src="<?= base_url() ?>assets/media/listings/03_100x75.jpg" width="100" height="75" alt="thumb">
                                            </a>
                                        </figure>
                                    </div>
                                    <div class="media-body">
                                        ...
                                        <div class="figure-block">
                                            <figure class="item-thumb">
                                                ...
                                                <a href="#" class="hover-effect">
                                                    <img src="<?= base_url() ?>assets/media/listings/01_370x202.jpg" width="370" height="202" alt="thumb">
                                                </a>
                                                <div class="price">
                                    ...
                                    <div class="item">
                                        <div class="figure-block">
                                            <figure class="item-thumb">
                                                ...
                                                <a href="#" class="hover-effect">
                                                    <img src="<?= base_url() ?>assets/media/listings/02_370x202.jpg" width="370" height="202" alt="thumb">
                                                </a>
                                                <div class="price">
                                                    <span class="item-price">$350,000</span>
                                                </div>
                                    ...
                                    <div class="item">
                                        <div class="figure-block">
                                            <figure class="item-thumb">
                                                ...
                                                <a href="#" class="hover-effect">
                                                    <img src="<?= base_url() ?>assets/media/listings/03_370x202.jpg" width="370" height="202" alt="thumb">
                                                </a>
                                                <div class="price">
                                                    <span class="item-price">$350,000</span>
                                                </div>
