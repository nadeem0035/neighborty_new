<div id="search_items">
        <script>
            var current_query = "<?php parse_str($_SERVER['QUERY_STRING']);?>";
        </script>
                                                    ...
                                                    <div class="property-item property-item-grid table-list">
                                                        ...
                                                        <div class="item-body table-cell">
                                                            <div class="table-list full-width hide-on-list">
                                                                <h2 class="property-title" style="max-width:100%"><a href="<?=site_url("property/".$list->slug.'-'.$list->listid)?>"><?=ucwords($list->title)?></a></h2>
                                                        ...
                                                        <div class="table-cell">
                                                            <div class="figure-block">
                                                                <figure class="item-thumb">
                                                                    ...
                                                                    <!--
                                                                    <a class="hover-effect" href="<?=site_url("property/".$list->slug.'-'.$list->listid)?>" style="background-image:url('<?=$list_img?>');" title="<?=ucwords($list->title)?>" alt="<?=ucwords($list->title)?>">
