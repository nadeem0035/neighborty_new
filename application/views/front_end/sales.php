    ...
    <section id="section-body">
        <div class="container">
            <div class="page-title breadcrumb-top">
                <div class="row">
                    <div class="col-sm-12">
                        <ol class="breadcrumb"><li ><a href=""><i class="fa fa-home"></i></a></li><li class="active">Sales</li></ol>
                        <div class="page-title-left">
                            <h1 class="title-head">For Sales</h1>
                        </div>
                                        ...
                                        <div class="table-cell">
                                            <div class="figure-block">
                                                <figure class="item-thumb">
                                                    ...
                                                    <a href="<?=site_url()?>sales/detail/apartment" class="hover-effect">
                                        ...
                                        <div class="item-body table-cell">
                                            <div class="body-left table-cell">
                                                <div class="info-row">
                                                    ...
                                                    <h2 class="property-title"><a href="<?=site_url()?>sales/detail/apartment">Apartment Oceanview</a></h2>
