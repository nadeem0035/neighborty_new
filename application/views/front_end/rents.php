    ...
    <section id="section-body">
        <div class="container">
            <div class="page-title breadcrumb-top">
                <div class="row">
                    <div class="col-sm-12">
                        <ol class="breadcrumb"><li ><a href=""><i class="fa fa-home"></i></a></li><li class="active">Rent</li></ol>
                        <div class="page-title-left">
                            <h1 class="title-head">For Rent</h1>
                        </div>
                        <div class="page-title-right">
                            ...
                            <div class="sort-tab table-cell text-right" style="padding-top:10px;">
                                Sort by:
                                            ...
                                            <div class="figure-block">
                                                <figure class="item-thumb">
                                                    ...
                                                    <div class="label-wrap label-right hide-on-list">
                                                        ...
                                                        <span class="label label-danger">Best offer</span>
                                                    </div>
                                                    ...
                                                    <a href="<?=site_url()?>rents/detail/apartment" class="hover-effect">
                                                        <img src="<?=base_url()?>assets/img/listings/07_385x258.jpg" alt="thumb">
                                                    </a>
                                                    <ul class="actions">
                                                        <li>
                                        ...
                                        <div class="item-body table-cell">
                                            <div class="body-left table-cell">
                                                <div class="info-row">
                                                    ...
                                                    <h2 class="property-title"><a href="<?=site_url()?>rents/detail/apartment">Apartment Oceanview</a></h2>
                                ...
                                <form>
                                    ...
                                    <div class="range-block rang-form-block">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    <select class="selectpicker" data-live-search="false" title="Property Type">
                                            ...
                                            <div class="col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <select class="selectpicker" data-live-search="false" title="Beds">
                                            ...
                                            <div class="col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <select class="selectpicker" data-live-search="false" title="Baths">
                                            ...
                                            <div class="col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    <select class="selectpicker" data-live-search="false" title="Status">
                        ...
                        <div class="widget widget-reviews">
                            ...
                            <div class="widget-body">
                                <div class="media">
                                    <div class="media-left">
                                        <a href="#">
                                            <img class="media-object img-circle" src="<?=base_url()?>assets/img/agents/01-350x350.jpg" alt="Thumb" width="50" height="50">
                                        </a>
                                    </div>
                                    <div class="media-body">
