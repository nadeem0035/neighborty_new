 ...
 */
$config['APIUsername'] = $config['Sandbox'] ? 'sheensoltech_api1.gmail.com' : 'PRODUCTION_USERNAME_GOES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? 'DJ67PKURAPWEPPCL' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'AFcWxV21C7fd0v3bYYYRCpSSRl31AvEVjNIsFClx4.c9.G.vSz.0hLtk' : 'PRODUCTION_SIGNATURE_GOES_HERE';
